...
; first element of the sequence with the result of combining all the elements to the right. There
; is also a fold-left, which is similar to fold-right, except that it combines elements working in
