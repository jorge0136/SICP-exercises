...
; then the value of (accumulate-n + 0 s) should be the sequence (22 26 30). Fill in the missing expressions in the
...
; I initially thought we were iterating by list and not by index of the list. 
