#lang sicp
; Exercise 2.19: Consider the change-counting program of 1.2.2. It would be nice to be able to
...
; The order of the coins does not matter because the procedure recurses over all the denominations of coin before returning.
