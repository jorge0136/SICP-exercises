...
;   if (= 0 0)
;   (remainder (remainder 206 40) (remainder 40 (remainder 206 40))) ;; 7 more `remainder` evaluations while assessing a. 18 total
; > 2

; Using Normal Order evaluation, remainder is called 14 times.
