...
;; is the function x↦x+n. If f is the operation of squaring a number, then the nth repeated
;; application of f is the function that raises its argument to the 2n-th power. Write a procedure
;; that takes as inputs a procedure that computes f and a positive integer n and returns the
